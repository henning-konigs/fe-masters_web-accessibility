...
const ScreenReaderImageGallery = () => {
	return (
		<div className="grid grid-cols-7 grid-row-1 gap-2">
			...
			<div className="my-2 col-span-3">
				<img
					alt="Picture of Hawaii while the sun is setting"
					src="/exercises/hawaii.jpg"
					className="object-cover w-full max-h-full mb-2"
				/>
				<em>Hawaii calls!</em>
			</div>
		</div>
